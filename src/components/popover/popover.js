(function() {
  ...
  angular.module('material.components.popover', [
      ...
      .directive('mdPopover', ['$timeout', '$window', '$$rAF', '$document', '$mdUtil',
        '$mdTheming', '$rootElement', '$mdAria', '$mdConstant', MdPopoverDirective]);
  ...
  function MdPopoverDirective($timeout, $window, $$rAF, $document, $mdUtil,
    ...
    function postLink(scope, element, attr, contentCtrl) {
      ...
      var debouncedOnResize = $mdUtil.debounce(function windowResize() {
      ...
      function positionPopover() {
        var popoverRect = $mdUtil.clientRect(element, popoverParent);
        var parentRect = $mdUtil.clientRect(parent, popoverParent);
